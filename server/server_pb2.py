...
_GETCHARACTERSREPLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='characters', full_name='session.GetCharactersReply.characters', index=1,
