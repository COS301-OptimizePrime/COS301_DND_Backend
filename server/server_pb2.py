...
_SESSIONSMANAGER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Get',
    full_name='session.SessionsManager.Get',
    index=5,
    containing_service=None,
